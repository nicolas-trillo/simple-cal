...
Lun.set(4, 'Ingles B')
Lun.set(5, 'Ingles C')
Lun.set(6, 'Arte Teatro')
Lun.set(7, 'Artes Plasticas')
Lun.set(8, 'Arte Musica')
...
classLinks.set('inB', 'https://classroom.google.com/u/NDExNTU2Njk1NjUx')
...
classLinks.set('QAP', 'https://classroom.google.com/c/NDA4MTE3MTA1OTcx')
